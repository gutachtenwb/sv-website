    ...
    <footer className="bg-graphit text-nebel mt-32">
      <div className="max-w-content mx-auto px-6 py-16 grid gap-12 md:grid-cols-4">
        ...
        <div className="text-sm">
          ...
          <p className="text-nebel/80">Musterstraße 12</p>
          <p className="text-nebel/80">12345 Musterstadt</p>
          <p className="mt-2 text-nebel/80">01234 / 567 890</p>
          <p className="text-nebel/80">info@kfz-gutachten-mustermann.de</p>
        </div>
